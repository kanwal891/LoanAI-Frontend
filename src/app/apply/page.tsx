...
export default function ApplyPage() {
  ...
  return (
    <main className="min-h-screen bg-[#080B14]">
      <GlassSidebar />
      {/* ml-64 offsets exactly for GlassSidebar's fixed width (w-64 = 256px expanded).
          Note: GlassSidebar can collapse to w-20 (80px) via its own internal state,
          which this static offset won't track — see note below. */}
